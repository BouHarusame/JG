        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="人员编码：">
              <el-select v-model="pMemberData.memberId" @change="handleGetMemberInfo" style="width:100%;">
                <el-option v-for="(c, i) in membersList" :key="i" :label="c.memberId" :value="c.memberId"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="姓名：">
              <el-input v-model="pMemberData.name" readonly></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="性别：">
              <el-input v-model="pMemberData.sex" readonly></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="年龄">
              <el-input v-model="pMemberData.age" readonly></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="职称：">
              <el-input v-model="pMemberData.title" readonly></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="专业：">
              <el-input v-model="pMemberData.professional" readonly></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="备注：">
              <el-input type="textarea" :rows="5" v-model="pMemberData.memberMark"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
