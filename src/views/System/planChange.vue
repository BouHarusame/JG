<template>
  <div class="proChange rs_view_item">
    <el-card>
      ...
      <el-row class="rs_p_row" :gutter="20">
        ...
        <el-col :span="cardSpanRight">
          <el-card class="rs_ps_card">
            <p slot="header"><el-button @click="handleClickToggle" type="text" style="float:left;margin: -11px 10px 0 0;" :icon="icon"></el-button>项目计划变更记录</p>
            <el-table
                border
                style="width: 100%"
                :data="changeData"
             ...
             <el-table-column
              ...
              <el-table-column label="变更编码">
                <template slot-scope="scope">
                  <p class="table-column">{{scope.row.id}}</p>
                </template>
              </el-table-column>
              <el-table-column label="变更内容">
                <template slot-scope="scope">
                  <p class="table-column">{{scope.row.content}}</p>
                </template>
              </el-table-column>
              <el-table-column label="变更原因">
                <template slot-scope="scope">
                  <p class="table-column">{{scope.row.cause}}</p>
                </template>
              </el-table-column>
              <el-table-column label="状态">
                <template slot-scope="scope">
                  <p class="table-column">{{scope.row.state}}</p>
                </template>
              </el-table-column>
              <el-table-column label="变更下达时间" width="120">
                <template slot-scope="scope">
                  <p class="table-column">{{scope.row.orderTime}}</p>
                </template>
              </el-table-column>
              <el-table-column label="计划完成时间" width="120">
                <template slot-scope="scope">
                  <p class="table-column">{{scope.row.planTime}}</p>
                </template>
              </el-table-column>
              <el-table-column label="实际完成时间" width="120">
                <template slot-scope="scope">
                  <p class="table-column">{{scope.row.finishTime}}</p>
                </template>
              </el-table-column>
              <el-table-column label="维护人" width="120">
                <template slot-scope="scope">
                  <p class="table-column">{{scope.row.maintenance}}</p>
                </template>
              </el-table-column>
              <el-table-column label="维护时间" width="120">
                <template slot-scope="scope">
                  <p class="table-column">{{scope.row.maintenanceTime}}</p>
                </template>
              </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="addDialog">
      <el-form label-width="100px">
        ...
        <div class="rs_form_item">
          <div class="rs_form_item_title">变更前</div>
          <el-row>
            <el-col :span="12">
        ...
        <div class="rs_form_item">
          <div class="rs_form_item_title">变更后</div>
          <el-row>
            <el-col :span="12">
              <el-form-item label="开始时间：">
                <el-date-picker value-format="yyyy-MM-dd"  style="width:100%"></el-date-picker>
      ...
      changeData: [
        {
          ...
          cause: '需求变动',
          state: '审核',
          orderTime: '2018-02-03',
          planTime: '2018-02-04',
          finishTime: '2018-02-04',
          maintenance: '刘海军',
          maintenanceTime: '2018-02-04',
          mark: '备注信息'
        },
        {
          id: 78546,
          ...
          cause: '需求变动',
          state: '审核',
          orderTime: '2017-02-03',
          planTime: '2017-02-04',
          finishTime: '2017-02-04',
          maintenance: '李向阳',
          maintenanceTime: '2017-02-04',
          mark: ''
        }
      ]
      // pointShow: false
